...
export function GetEmployee(parameter) { return apiResquest({ url: '/Member/Fans/GetEmployee', method: 'post', data: parameter }); }
export function UpdatePhone(parameter) { return apiResquest({ url: '/Member/Update/Phone', method: 'post', data: parameter }); }