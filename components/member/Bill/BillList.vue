					...
					<form action method class="comment-form" id="comment-form" @submit.prevent="submit">
						<div class="star-box">
							<div class="star-item" v-for="(item,index) in starlist" :key="index">
								...
								<i class="iconfont iconwujiaoxingquanxing" :class="{'active':item.star > 0}"
									data-index="0" @click="rating(index,0)"></i>
								<i class="iconfont iconwujiaoxingquanxing" :class="{'active':item.star > 1}"
									data-index="1" @click="rating(index,1)"></i>
								<i class="iconfont iconwujiaoxingquanxing" :class="{'active':item.star > 2}"
									data-index="2" @click="rating(index,2)"></i>
								<i class="iconfont iconwujiaoxingquanxing" :class="{'active':item.star > 3}"
									data-index="3" @click="rating(index,3)"></i>
								<i class="iconfont iconwujiaoxingquanxing" :class="{'active':item.star > 4}"
									data-index="4" @click="rating(index,4)"></i>
							</div>
						</div>
						<div class="cot">
